Important (wrote by Hive-Discover):
We used this library but do not want to rehost it in our repo. Check it [here](https://github.com/nmslib/hnswlib) out! It is amazing...
